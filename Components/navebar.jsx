    ...
    <div className="container">
      <div className="header-inner">
        <nav id="site-navigation" className="main-nav">
            ...
            <ul className="codeboxr-main-menu">
              ...
              <li className="has-submenu menu-item-depth-0">
                ...
                <ul className="sub-menu">
                  ...
                  <li>
                    <a href="blog-left-sidebar.html">Blog List Left Sidebar</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="blog-grid-nosidebar.html">Blog Grid No Sidebar</a>
                  </li>
                  <li>
                    <a href="blog-grid-three-column.html">Blog Grid 3 Column</a>
                  </li>
                  <li>
          ...
          {/* /.menu-wrapper */}
          <a className="cbx-btn btn-brand" href="signin.html">
            Login/Signup
          </a>
        </nav>
        {/* /.site-nav */}
